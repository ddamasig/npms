                    ...
                    <div class="panel-body">
                        <form method="POST" action="/user/{{ $user->id }}/account">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="password" placeholder="Password is hidden" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password">
                    ...
                    <div class="panel-body">
                        <form method="POST" action="/user/{{ $user->id }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="middle_name" value="{{ $user->middle_name }}" type="text" class="form-control{{ $errors->has('middle_name') ? ' is-invalid' : '' }}" name="middle_name" value="{{ old('middle_name') }}" required autofocus>
