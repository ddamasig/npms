                ...
                <div class="panel-body">
                    <form method="POST" action="/projects/{{ $project->id }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="client" type="text" class="form-control{{ $errors->has('client') ? ' is-invalid' : '' }}"
                                    name="client" value="{{ $project->client }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select-search url="/api/users" name="manager_id" text-key="full_name" default-value="{{ $project->manager_id }}"
                                    default-text="{{ $project->manager->full_name }}" value-key="id"></select-search>
                            ...
                            <div class="col-md-4">
                                <select-search url="/api/users" name="contact_id" text-key="full_name" default-value="{{ $project->contact_id }}"
                                    default-text="{{ $project->contact->full_name }}" value-key="id"></select-search>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea rows="8" id="description" type="text" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}"
                                    name="description" required autofocus>{{  htmlspecialchars(trim($project->description)) }}</textarea>
